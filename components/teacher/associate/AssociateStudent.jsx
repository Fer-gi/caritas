...
import { associateStudent, disassociateStudent,getWorkshop,} from "../../../firebase/controllers/teacher/associate/associate";
        ...
        <Card key={workshop.id} style={{ width: "18rem" }}>
          ...
          <ListGroup className="text-center">
            <input
              ...
              style={{ backgroundColor: "rgba(255, 145, 145, 0.548)" }}
          ...
          >
            <Button
              className="cardbtn"
              style={{ width: "7rem", margin: ".05rem" }}
              variant="danger"
              onClick={() =>
                disassociateStudent(emailInput, id, setWorkshop, setEmailInput)
              }
            >
              Desasociar
            </Button>
            <Button
              ...
              variant="danger"
              onClick={() =>
                associateStudent(emailInput, id, setWorkshop, setEmailInput)
              }
            >
              Asociar
            </Button>
